...
namespace OASPlash.Core.Model
{
    ...
    public partial class CurrentUser : IEquatable<CurrentUser>, IValidatableObject
    {
        ...
        /// <param name="uploadsRemaining">uploadsRemaining.</param>
        ...
        /// <summary>
        /// Gets or Sets UploadsRemaining
        /// </summary>
        [DataMember(Name = "uploads_remaining", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UploadsRemaining: ").Append(UploadsRemaining).Append("\n");
        ...
        public bool Equals(CurrentUser input)
        {
            ...
            return 
                ...
                (
                    this.UploadsRemaining == input.UploadsRemaining ||
                    this.UploadsRemaining.Equals(input.UploadsRemaining)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.UploadsRemaining.GetHashCode();
